	...
	private Connection con;
	  ...
	  public boolean insert(Object obj)
	  {
	    ...
	    try
	    {
	      ...
	      this.query = 
	        ("insert into tbBank values ('" + this.info.getId() + "'," + this.info.getBalance() + ",'" + this.info.getPwd() + "','" + this.info.getTransferTo() + this.info.getTransferAmount()  + ");");
	  ...
	  public boolean modify(Object obj)
	  {
	    ...
	    try
	    {
	      Statement stmt = this.con.createStatement();
	      this.query = 
	        ("update tbBank set balance=" + this.info.getBalance() + ",pwd='" + this.info.getPwd() + ",transferTo=" + this.info.getTransferTo() + "',transferAmount=" + this.info.getTransferAmount() + " where userID='" + this.info.getId() + "';");
	      System.out.println(this.query);
	      if (stmt.executeUpdate(this.query) != 0) {
	        return true;
	      }
